...
class S_CHAT final :
 ...
 public:
  ...
  // uint64 plyerId = 1;
  void clear_plyerid();
  uint64_t plyerid() const;
  void set_plyerid(uint64_t value);
  private:
  uint64_t _internal_plyerid() const;
  void _internal_set_plyerid(uint64_t value);
  public:
...
// uint64 plyerId = 1;
inline void S_CHAT::clear_plyerid() {
  _impl_.plyerid_ = uint64_t{0u};
}
inline uint64_t S_CHAT::_internal_plyerid() const {
  return _impl_.plyerid_;
}
inline uint64_t S_CHAT::plyerid() const {
  // @@protoc_insertion_point(field_get:Protocol.S_CHAT.plyerId)
  return _internal_plyerid();
}
inline void S_CHAT::_internal_set_plyerid(uint64_t value) {
  
  _impl_.plyerid_ = value;
}
inline void S_CHAT::set_plyerid(uint64_t value) {
  _internal_set_plyerid(value);
  // @@protoc_insertion_point(field_set:Protocol.S_CHAT.plyerId)
}
