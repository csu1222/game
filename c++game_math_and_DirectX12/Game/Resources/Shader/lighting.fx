...
VS_OUT VS_DirLight(VS_IN input)
{
    ...
    // input.pos 에 2.f 를 곱해주는 이유는 Directional Light 가 화면을 꽉 채우는 Rectangle Mesh 인데 
    // Resources 에서 만들어둔 Rectangle Mesh 는 가로,세로 0.5f 씩을 가진 메쉬이기 때문에 Projection 좌표계의 크기인 -1 ~ 1 을 맞춰주기 위함
    output.uv = input.uv;
